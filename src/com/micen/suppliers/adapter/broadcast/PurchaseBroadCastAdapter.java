...
public class PurchaseBroadCastAdapter extends BroadCastBaseAdapter
{
	public PurchaseBroadCastAdapter(Activity activity, ArrayList<BroadCastContent> dataList)
	{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2)
	{
		...
		holder.purchaseContentLayout.setVisibility(View.VISIBLE);
