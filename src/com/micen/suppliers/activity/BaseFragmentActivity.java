...
public class BaseFragmentActivity extends FragmentActivity implements OnClickListener
{
	...
	private BroadcastReceiver receiver = new BroadcastReceiver()
	{
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if (99999 == code)
			{
				ToastUtil.toast(BaseFragmentActivity.this, intent.getStringExtra("reLoginReason"));
				// 重新登录
			...
			else if (30001 == code)
			{
				...
				// 登录失败
				SysManager.logout();
				SysManager.exitSystem(BaseFragmentActivity.this);
				startActivity(new Intent(BaseFragmentActivity.this, LoginActivity_.class));
			}
		}
	};
